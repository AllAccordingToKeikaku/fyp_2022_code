...
<html>
  ...
  <body style="background-color:#518196">
  <a href="main_page.html"><img src="/fyp_codes/MoshiQ2 Assets/Logo.png" style="width:300px;margin-left:auto;margin-right:auto;width:500px;display:block"></a></br>
  ...
  <form action="reservation_details_data.php/" method="POST">
    ...
    <fieldset style="width:434px">
      ...
      <text style="color:rgb(218, 216, 214)">Account ID<span style="margin-left:18px"></span>: </text><input id="accountID" type="text" disabled><br>
      <text style="color:rgb(218, 216, 214)">Name<span style="margin-left:55px"></span>: </text><input id="name" style="margin-top:5px" type="text" required><br>
      <text style="color:rgb(218, 216, 214)">Email address<span style="margin-left:3px"></span>: </text><input id="emailAddress" style="margin-top:5px" type="email" required><br>
      <text style="color:rgb(218, 216, 214)">Phone number: </text><input id="phoneNumber" style="margin-top:5px" type="text" onkeypress="return /[0-9]/i.test(event.key)" required><br>
    </fieldset><br>

    <fieldset style="width:434px">
      <legend style="color:antiquewhite">Select Outlet</legend>
      <text style="color:rgb(218, 216, 214)">Location: </text><select name="outletLocation" id="outletLocation" style="width:120px;text-align:center" onchange="selectedPax();selectedArea()">
    ...
    <fieldset style="width:434px">
      ...
      <text style="color:rgb(218, 216, 214)">Time slot: </text><select name="timeSelect" id="timeSelect" style="width:60px;text-align:center" onchange="selectedPax();selectedArea()">
      ...
      <text style="color:rgb(218, 216, 214)">Amount of people: </text><select name="pax" id="pax" style="width:60px;text-align:center" onchange="selectedPax();selectedArea()">
    ...
    <fieldset style="width:434px">
      ...
      <input type="checkbox" id="A" class="seatingArea" name="A" value="A" onclick="selectedArea()" disabled="true"/><label for="A">A</label><br>
      <input type="checkbox" id="B" class="seatingArea" name="B" value="B" onclick="selectedArea()" disabled="true"/><label for="B">B</label><br>
      <input type="checkbox" id="C" class="seatingArea" name="C" value="C" onclick="selectedArea()" disabled="true"/><label for="C">C</label><br>
      <input type="checkbox" id="D" class="seatingArea" name="D" value="D" onclick="selectedArea()" disabled="true"/><label for="D">D</label><br>
      <input type="checkbox" id="E" class="seatingArea" name="E" value="E" onclick="selectedArea()" disabled="true"/><label for="E">E</label><br>
      <input type="checkbox" id="F" class="seatingArea" name="F" value="F" onclick="selectedArea()" disabled="true"/><label for="F">F</label><br>
      <input type="checkbox" id="G" class="seatingArea" name="G" value="G" onclick="selectedArea()" disabled="true"/><label for="G">G</label><br>
      <input type="checkbox" id="H" class="seatingArea" name="H" value="H" onclick="selectedArea()" disabled="true"/><label for="H">H</label><br>
      <input type="checkbox" id="I" class="seatingArea" name="I" value="I" onclick="selectedArea()" disabled="true"/><label for="I">I</label><br>
      <input type="checkbox" id="J" class="seatingArea" name="J" value="J" onclick="selectedArea()" disabled="true"/><label for="J">J</label><br>
    </fieldset><br>
